...
<button class="tablink" onclick="openPage('SimpleCalculator', this, '#ff8080')" id="defaultOpen">Simple Calculator</button>
<button class="tablink" onclick="openPage('AgeCalculator', this, '#ff8080')" >Age Calculator</button>
<button class="tablink" onclick="openPage('EMICalculator', this, '#ff8080')" >EMI Calculator</button>
